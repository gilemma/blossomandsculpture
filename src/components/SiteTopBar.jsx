...
export default function SiteTopBar() {
  ...
  return (
    <div className="bg-[#c4d9d8] text-[10px] max-[399px]:text-[9px] sm:text-xs uppercase tracking-[0.12em] max-[399px]:tracking-[0.08em] text-gray-800">
      <div className="mx-auto grid h-7 max-w-7xl grid-cols-[1fr_minmax(0,40rem)_1fr] items-center gap-3 max-[399px]:gap-2 px-2 max-[399px]:px-1 sm:px-6 md:px-10">
        <span className="shrink-0 ">
          <SocialIconsComponent /></span>
